...
export default function NavigationFooter(){
    ...
    return(<div className="navigation-footer">
                <div className="footer-elements-ul">
                    <div className="footer-element-li" id="home" onClick={goBackHomePage}>Home</div> 
                    <div className="footer-element-li" id='about-us' onClick={displayWebPage}>About Us</div>
